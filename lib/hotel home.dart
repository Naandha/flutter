...
class _HomepagehotelState extends State<Homepagehotel> {
  var image = [
    "assets/image/hotel 1.webp",
    "assets/image/hotel2.jpg",
    "assets/image/hotel3.jpg"
  ];
  var name = [
    "awosome room naer bohdha",
    "awosome room naer calicut",
    "awosome room naer kochi"
  ];
  var subname = ["bodha ,karnadaka", "calicut,kerala", "kochi,kerala"];
  var price=["40","42","50"];
